...
%>
<div class="hidden w-full bottom-0 z-[99] top-[-420px] md:top-10 absolute flex justify-center items-center" id="addPromotionForm">
    <div class="p-4">
        <form action="<%=application.getInitParameter("url")%>PromotionServlet?post=promotion" method="post"
              class="bg-gray-50 md:bg-transparent w-full flex flex-col items-end shadow-sm rounded-lg">
            <div class="w-full h-full flex pt-4 flex-col items-center md:items-end">
