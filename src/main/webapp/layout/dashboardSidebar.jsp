...
<div class="h-full w-16 sm:w-56  bg-gray-100 fixed left-0">
...
<%--    </header>--%>
    <ul class="list-none mt-14 block">
        <li class="px-8 py-4 hover:bg-[#0043BD] hover:pl-12 hover:text-white bg-[#0043BD] text-white pl-12  transition-all duration-75"><a href="#" class="leading-10"><i class="fa-solid fa-chart-pie mr-4 inline-block"></i><h5 class="hidden sm:inline-block">Statistics</h5></a></li>
