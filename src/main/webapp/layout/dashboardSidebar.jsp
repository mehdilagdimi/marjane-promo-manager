...
<div class="h-full w-56 bg-gray-100 fixed left-0">
...
<%--    </header>--%>
    <ul class="list-none mt-14">
        ...
        <li class="px-8 py-4 hover:bg-[#0043BD] hover:pl-12 hover:text-white transition-all duration-75"><a href="#" class="block leading-10"><i class="fa-solid fa-people-roof mr-4"></i>Section Manager</a></li>
