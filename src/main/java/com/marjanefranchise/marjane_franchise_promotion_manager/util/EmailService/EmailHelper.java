package com.marjanefranchise.marjane_franchise_promotion_manager.util.EmailService;
...
public abstract class EmailHelper {
    ...
    public static void sendEmail(Session session, String toEmail, String fromEmail, String subject, String body){
        ...
        try
        {
            ...
            msg.setFrom(new InternetAddress(fromEmail, "Marjane BackOffice Email Service"));
